...
const mapStateToProps = (state) => ({
    tests: expertPanelTestsSelectors.getTests(state),
    perPage: appSelectors.getPerPage(state),
})

export default compose(connect(mapStateToProps, {changePerPage, addTest, updateTest, deleteTest}))(ExpertPanelTestsTable);